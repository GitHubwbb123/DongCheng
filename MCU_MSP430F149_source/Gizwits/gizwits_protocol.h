...
* @{
*/
#define PRODUCT_KEY "01e0fe474fec4b1e94fda97f45977af6"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "62844d53834b4e4d941f20de606e5c61"
...
#define LED4_LEN                           1
#define LED5_BYTEOFFSET                    0
#define LED5_BITOFFSET                     4
#define LED5_LEN                           1
#define LED6_BYTEOFFSET                    0
#define LED6_BITOFFSET                     5
#define LED6_LEN                           1
#define LED7_BYTEOFFSET                    0
#define LED7_BITOFFSET                     6
#define LED7_LEN                           1
#define LED8_BYTEOFFSET                    0
#define LED8_BITOFFSET                     7
#define LED8_LEN                           1
#define IN1_BYTEOFFSET                    1
#define IN1_BITOFFSET                     0
#define IN1_LEN                           1
#define IN2_BYTEOFFSET                    1
#define IN2_BITOFFSET                     1
#define IN2_LEN                           1
#define IN3_BYTEOFFSET                    1
#define IN3_BITOFFSET                     2
#define IN3_LEN                           1
#define IN4_BYTEOFFSET                    1
#define IN4_BITOFFSET                     3
#define IN4_LEN                           1

#define TEM1_RATIO                         0.1
#define TEM1_ADDITION                      -20
#define TEM1_MIN                           0
#define TEM1_MAX                           1200
#define TEM2_RATIO                         0.1
#define TEM2_ADDITION                      -20
#define TEM2_MIN                           0
#define TEM2_MAX                           1200
/**@} */
